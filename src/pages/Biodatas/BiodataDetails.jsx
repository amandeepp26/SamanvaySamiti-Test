...
const BiodataDetails = () => {
  const { id } = useParams();
  const [singleBiodata, , isSingleBiodataLoading] = null;
  const [typeBiodatas, refetchTypeBiodatas, isTypeBiodataLoading] = null;

  const { selfUser, refetchSelfUser } = null;

  const handleStoreFavorite = null;
