...
const ManageUsers = () => {
  ...
  const handleUserRoleUpdate = (userEmail) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axiosSecure
          .put(`/users/update-role/${userEmail}`)
          .then((res) => {
  ...
  const handleApprovedPremium = (userEmail) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axiosSecure
          .put(`/approved/user/to-premium/${userEmail}`)
          .then((res) => {
            if (
                            ...
                            {item?.userRole ? (
                              <>
                                <button
                                  ...
                                  onClick={() =>
                                    handleUserRoleUpdate(item?.email)
                                  }
                                >
                                  {" "}
                                  {item?.userRole}{" "}
                              ...
                              <>
                                <button
                                  className="font-medium text-base text-primary-normal"
                                  onClick={() =>
                                    handleUserRoleUpdate(item?.email)
                                  }
                                >
                            ...
                            {item?.isPro ? (
                              <>
                                <button
                                  ...
                                  onClick={() =>
                                    handleApprovedPremium(item?.email)
                                  }
                                >
                                  {" "}
                                  {item?.isPro}{" "}
