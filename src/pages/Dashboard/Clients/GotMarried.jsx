...
const GotMarried = () => {
  ...
  const onSubmit = (data) => {
    ...
    axiosSecure
      .post("/post-success-story", succssStory)
      .then((response) => {
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid gap-y-5">
          <div className="w-full">
            <label htmlFor="selfName" className="block mb-2 font-medium">
              {" "}
              Self Name*
            </label>
            <input
          ...
          <div className="w-full">
            <label htmlFor="partnerName" className="block mb-2 font-medium">
              {" "}
              Partner Name*
            </label>
            <input
          ...
          <div className="w-full">
            <label htmlFor="selfId" className="block mb-2 font-medium">
              {" "}
              Self Biodata ID*
            </label>
            <input
          ...
          <div className="w-full">
            <label htmlFor="partnerId" className="block mb-2 font-medium">
              {" "}
              Partner Biodata ID*
            </label>
            <input
          ...
          <div className="w-full">
            <label htmlFor="coupleImg" className="block mb-2 font-medium">
              {" "}
              Couple Image URL*
            </label>
            <input
