...
const EditBiodata = () => {
  ...
  const { selfBiodata, refetchSelfBiodata } = null;
  ...
  const onSubmit = (data) => {
    ...
    const biodata = {
      ...
      height: data.height,
      img:
        data.img || data.type === "Male"
          ? "https://i.ibb.co/R6yVpqY/male.jpg"
          : "https://i.ibb.co/cy4t8SN/female.jpg",
      inches: data.inches,
      mobile: data.mobile,
    ...
    if (selfBiodata?.biodataId) {
      axiosSecure
        .put(`biodatas/${user?.email}`, biodata)
        .then((response) => {
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 sm:gap-6">
            <div className="w-full">
              ...
              <input
                ...
                className="bg-gray-50 border border-gray-300 text-base rounded-lg block w-full p-2.5 text-gray-400"
            ...
            <div className="w-full">
              ...
              {errors?.type && (
                <span className="text-red-500"> Biodata Type is required</span>
              )}
            </div>
            ...
            <div className="w-full">
              ...
              <input
                ...
                id="img"
                {...register("img")}
                placeholder="https://placeholder.png"
                className="bg-gray-50 border border-gray-300 text-base rounded-lg block w-full p-2.5"
              />
            </div>
            ...
            <div className="w-full">
              ...
              {errors?.race && (
                <span className="text-red-500"> Race is required</span>
              )}
            </div>
            ...
            <div className="w-full">
              ...
              />
              {errors?.fathersName && (
                <span className="text-red-500"> Fathers name is required</span>
              )}
            </div>
            ...
            <div className="w-full">
              ...
              />
              {errors?.mothersName && (
                <span className="text-red-500"> Mothers name is required</span>
              )}
            </div>
            ...
            <div className="flex gap-3 items-center">
              <div className="w-full">
                <label
                  ...
                  className="block mb-2 text-xs font-medium text-gray-900 cursor-pointer"
                >
              ...
              <div className="w-full">
                <label
                  htmlFor="expectedPartnerInches"
                  className="block mb-2 text-xs font-medium text-gray-900 cursor-pointer"
                >
                  Expected partner inches*
                </label>
                <select
                  id="expectedPartnerInches"
                  {...register("expectedPartnerInches")}
                  className="bg-gray-50 border border-gray-300 text-base rounded-lg block w-full p-2.5"
                >
                  <option value="">Select option</option>
                  <option value="1">1 inc</option>
            ...
            <div className="w-full">
              ...
              />
              {errors?.email && (
                <span className="text-red-500"> Contact email is required</span>
              )}
            </div>
